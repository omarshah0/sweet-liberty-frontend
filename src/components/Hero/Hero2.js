...
const Hero2 = () => {
  return (
    <section className="bg-brandDark mx-auto mb-[220px] md:mb-[193px] lg:mb-[300px] relative">
      ...
      <div className="absolute top-[-100px] left-0 md:right-0 md:left-auto z-[5] flip md:straight">
        <StaticImage
      ...
      <div className="absolute bottom-[-300px] md:bottom-0 right-0 md:left-0 md:right-auto flip md:straight">
        <StaticImage
